 ...
 */
$itr_rf_submit_url = 'request/form.php';
?>
    ...
    <form id="itrrf-form" method="post" novalidate>
      ...
      <div class="itr-rf__page" data-itrrf-page="1">
        ...
        <div class="itr-rf__legal">
          ...
          <a href="/privacy-policy/">privacy policy</a> and for EIRE Tax Refunds to process your
        ...
        <div class="itr-rf__terms-row">
          <div class="itr-rf__checkbox-row">
            ...
            <label for="itrrf-fees">
              ...
              by EIRE Tax Refunds in respect of the services carried out on my behalf.
            </label>
          </div>
